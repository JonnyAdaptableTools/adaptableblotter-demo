...
export function setNorthwindHyperGridProperties(grid: any): void {
  ...
  behavior.dataModel.getCellEditorAt = function(
    columnIndex: any,
    rowIndex: any,
    declaredEditorName: any,
    options: any
  ) {
  ...
  grid.localization.add(
    'shortDateFormat',
    new grid.localization.DateFormatter('en-EN', shortDateOptions)
  );
  ...
  grid.localization.add(
    'longDateFormat',
    new grid.localization.DateFormatter('en-EN', longDateOptions)
  );

  grid.localization.add(
    'USDCurrencyFormat',
    new grid.localization.NumberFormatter('en-US', {
      style: 'currency',
      currency: 'USD',
