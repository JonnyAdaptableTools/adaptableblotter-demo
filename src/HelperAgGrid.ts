...
export function getBasicNorthwindColumnSchema(): any[] {
    ...
    schema.push({ headerName: "Order Id", field: "OrderId", editable: false, cellClass: 'number-cell', filter: true, sortable: true, type: 'abColDefNumber', });
    ...
    schema.push({ headerName: "Item Cost", field: "ItemCost", cellClass: 'number-cell', editable: false, filter: true, sortable: true, type: 'abColDefNumber', });
    schema.push({ headerName: "Item Count", field: "ItemCount", cellClass: 'number-cell', editable: false, filter: true, sortable: true, type: 'abColDefNumber', });
    ...
    schema.push({ headerName: "Freight", field: "Freight", cellClass: 'number-cell', cellRenderer: currencyRendereragGrid, editable: false, sortable: true, type: 'abColDefNumber', });
...
export function getGroupingNorthwindColumnSchema(): any[] {
    ...
    schema.push({
        ...
        marryChildren: true,
        children: [
            { headerName: "Order Id", field: "OrderId", editable: false, columnGroupShow: 'open', cellClass: 'number-cell', filter: true, sortable: true },
    ...
    schema.push({ headerName: "Item Cost", field: "ItemCount", cellClass: 'number-cell', columnGroupShow: 'closed', editable: false, enableValue: true, filter: true, sortable: true });
    schema.push({ headerName: "Item Count", field: "ItemCount", cellClass: 'number-cell', columnGroupShow: 'closed', editable: false, enableValue: true, filter: true, sortable: true });
    ...
    schema.push({ headerName: "Freight", field: "Freight", cellClass: 'number-cell', cellRenderer: currencyRendereragGrid, editable: false, enableValue: true, sortable: true });
