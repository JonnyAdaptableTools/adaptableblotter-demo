...
export var decimalPlaceRendereragGrid = (
  minDigits: number,
  maxDigits: number
) =>
  function(params: any) {
...
export function getAdaptableBlotterOptions(
...
export function getAadaptableBlotterOptionsWithDivNames(
  gridOptions: GridOptions,
  pk: string,
  blotterId: string,
  config: any,
...
export function getBasicNorthwindColumnSchema(): any[] {
  ...
  schema.push({
    ...
    field: 'InvoicedCost',
    cellClass: 'number-cell',
    cellRenderer: currencyRendereragGrid,
    editable: true,
    filter: true,
    sortable: true,
    type: 'abColDefNumber',
