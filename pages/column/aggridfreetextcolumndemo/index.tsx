...
export default () => {
  return (
    <DynamicDemoPage
      demo={import('../../../src/client/aggridfreetextcolumndemo')}
      pageTitle={'Free Text Column Demo'}
      description={
        <div>
          <h4>Free Text Column</h4>
          <p>
          ...
          <p>
            ...
            <a
              href="https://adaptabletools.zendesk.com/hc/en-us/articles/360020459051-Free-Text-Columns"
              target="_blank"
            >
              User Guide
            </a>
