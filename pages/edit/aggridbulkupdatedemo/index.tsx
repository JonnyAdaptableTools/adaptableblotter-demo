  ...
  return (
    <DynamicDemoPage
      ...
      helpResources={
        <div>
          <a
            href="https://api.adaptabletools.com/interfaces/_predefinedconfig_bulkupdatestate_.bulkupdatestate.html"
            target="_blank"
          >
            Predefined Config
          </a>
          ,{' '}
          <a
            href="https://api.adaptabletools.com/interfaces/_api_bulkupdateapi_.bulkupdateapi.html"
            target="_blank"
          >
            Adaptable API
          </a>
