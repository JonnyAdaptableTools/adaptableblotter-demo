      ...
      description={
        <div>
          ...
          <p>
            ...
            <a
              href="https://api.adaptabletools.com/interfaces/_predefinedconfig_quicksearchstate_.quicksearchstate.html"
              target="_blank"
            >
              Predefined Config
            </a>
            ,{' '}
            <a
              href="https://api.adaptabletools.com/interfaces/_api_quicksearchapi_.quicksearchapi.html"
              target="_blank"
            >
              Adaptable API
            </a>
