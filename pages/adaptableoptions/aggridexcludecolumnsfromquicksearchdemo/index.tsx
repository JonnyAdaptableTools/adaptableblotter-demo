      ...
      description={
        <div>
          ...
          <p>
            ...
            <a
              href="https://api.adaptableblotter.com/interfaces/_adaptableoptions_searchoptions_.searchoptions.html#excludecolumnfromquicksearch"
              target="_blank"
            >
              Search Options
            </a>{' '}
          ...
          <p>
            ...
            <a
              href="https://api.adaptableblotter.com/interfaces/_adaptableoptions_searchoptions_.searchoptions.html"
              target="_blank"
            >
              Adaptable Options
            </a>
