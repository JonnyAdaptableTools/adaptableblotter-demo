...
import config from '../../src/client/aggriddashboardvisibilitydemo/config';

const DynamicComponent = dynamic(
  () => import('../../src/client/aggriddashboardvisibilitydemo'),
  {
    loading: () => null,
    ssr: false,
  }
...
export default () => {
  ...
  return (
    <AgGridDemoPage
      ...
      description={
        <div>
          <h4>Configuring Dashboard Visibility</h4>
          <p>
