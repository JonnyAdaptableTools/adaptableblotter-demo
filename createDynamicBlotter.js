...
function convertToJSON(data) {
  ...
  for (var i = 1; i < dataRowCount; i++) {
    ...
    for (var x = 0; x < colNamesLength; x++) {
      ...
      // doing this as if its undefined, then nothing is in the JSON for key or value, so I think null is better?
      returnData[currentColName] = value == undefined ? null : value;
    }
