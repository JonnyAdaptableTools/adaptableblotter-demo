...
module.exports = {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      {
        context: 'node_modules/adaptableblotter/dist',
        from: '*',
        to: PACKAGE.version + '/',
      },
    ]),
    ...
    new CopyWebpackPlugin([
      { from: 'node_modules/adaptableblotter/LICENSE.md', to: '' },
    ]),
    new CopyWebpackPlugin([{ from: 'DemoPage/*', to: '', flatten: true }]),
    new CopyWebpackPlugin([
      { from: 'DataSets/Json/*.json', to: '', flatten: true },
    ]),
    new CopyWebpackPlugin([
      { from: 'src/DataSets/**/*.json', to: '', flatten: true },
    ]),
