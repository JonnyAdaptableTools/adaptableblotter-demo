    ...
    Categories: [
      {
        ...
        Pages: [
          ...
          {
            Name: 'AutoGenerated PK',
            Link: '/gettingstarted/aggridautogeneratedpriamarykeydemo',
            Description:
              'AdapTable cannot auto generate a Primary Key for you (if there is no alternative).',
          },
        ],
      },
      {
